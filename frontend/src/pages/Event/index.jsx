...
const EventDashboardMenu = ({id}) => {
  return (
    <nav aria-label="Main Nav" class="flex flex-col space-y-1 py-5">
      <a href={`/academy/event/${id}/home`} class="flex items-center rounded-lg bg-gray-100 px-4 py-2 text-gray-700">
        <svg
        ...
        <div className="col-span-4 text-left rounded-2xl border border-black py-10 px-10 shadow-lg">
          ...
          <div className="">
            <h2 className="flex justify-between my-1">
              ...
              <a href={`/academy/event/${id}/project`} className="text-sm rounded-full border border-gray-600 px-4 py-2">Create/Edit Project</a>
            </h2>
